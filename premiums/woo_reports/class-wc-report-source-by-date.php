	...
	private function query_report_data() {
		...
		$this->report_data->order_counts = (array) $this->get_order_report_data(
			array(
				...
				'order_status' => array( 'completed', 'processing', 'on-hold', 'refunded', 'part-payment-paid' ),
                'debug'        => false
			)
		);
		...
		$this->report_data->partial_refunds = (array) $this->get_order_report_data(
			array(
				...
				'filter_range'        => true,
				'order_status'        => false,
				'parent_order_status' => array( 'completed', 'processing', 'on-hold', 'part-payment-paid' ),
			)
		);
		...
		$this->report_data->refund_lines = (array) $this->get_order_report_data(
			array(
				...
				'filter_range'        => true,
				'order_status'        => false,
				'parent_order_status' => array( 'completed', 'processing', 'on-hold', 'refunded', 'part-payment-paid' ),
			)
		);
